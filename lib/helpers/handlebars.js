...
function isArray(item, options) {
  if (Array.isArray(item)) return options.fn(this);
}
...
function isBoolean(item, options) {
  if (typeof item === `boolean`) return options.fn(this);
...
function isDefined(item, options) {
  if (item !== undefined) return options.fn(this); // eslint-disable-line no-undefined
  return options.inverse(this);
}
...
function isTrue(item, options) {
  if (item === true) return options.fn(this);
  return options.inverse(this);
}
...
function emptySchema(schema, options) {
  ...
  if (isEmptySchema) return options.fn(this);
  return options.inverse(this);
